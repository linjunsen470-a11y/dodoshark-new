          ...
          <div className="lg:w-1/2 w-full flex justify-center">
            <div className="relative w-full max-w-3xl aspect-[4/3]">
              <Image 
                ...
                alt="Corn Production Line Banner" 
                fill
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="premium-card p-8 rounded-2xl group border border-slate-100 hover:border-orange-100 transition-all bg-slate-50 hover:bg-white shadow-sm hover:shadow-xl hover:shadow-orange-500/5 text-center">
              <div className="h-16 w-16 mb-6 relative grayscale group-hover:grayscale-0 transition-all duration-500 mx-auto">
                <Image src="/assets/images/solutions/temp/low-cost-high-roi.png" alt="Low Cost" fill className="object-contain" />
              </div>
            ...
            <div className="premium-card p-8 rounded-2xl group border border-slate-100 hover:border-orange-100 transition-all bg-slate-50 hover:bg-white shadow-sm hover:shadow-xl hover:shadow-orange-500/5 text-center">
              <div className="h-16 w-16 mb-6 relative grayscale group-hover:grayscale-0 transition-all duration-500 mx-auto">
                <Image src="/assets/images/solutions/temp/clean-workshop.png" alt="Clean Workshop" fill className="object-contain" />
              </div>
            ...
            <div className="premium-card p-8 rounded-2xl group border border-slate-100 hover:border-orange-100 transition-all bg-slate-50 hover:bg-white shadow-sm hover:shadow-xl hover:shadow-orange-500/5 text-center">
              <div className="h-16 w-16 mb-6 relative grayscale group-hover:grayscale-0 transition-all duration-500 mx-auto">
                <Image src="/assets/images/solutions/temp/excellent-quality.png" alt="Excellent Quality" fill className="object-contain" />
              </div>
            ...
            <div className="premium-card p-8 rounded-2xl group border border-slate-100 hover:border-orange-100 transition-all bg-slate-50 hover:bg-white shadow-sm hover:shadow-xl hover:shadow-orange-500/5 text-center">
              <div className="h-16 w-16 mb-6 relative grayscale group-hover:grayscale-0 transition-all duration-500 mx-auto">
                <Image src="/assets/images/solutions/temp/efficiency-improvement.png" alt="Efficiency Improvement" fill className="object-contain" />
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/3">
              ...
              <div className="relative w-full aspect-[4/3] mb-6 overflow-hidden">
                <Image src="/assets/images/solutions/temp/corn.jpg" alt="Corn Raw Material" fill className="object-cover rounded-2xl" />
              </div>
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="rounded-xl bg-slate-50 p-6 flex flex-col">
              <div className="mb-4 h-40 relative overflow-hidden">
                <Image src="/assets/images/solutions/temp/unstable-performance.jpg" alt="Unstable Performance" fill className="object-cover rounded-lg" />
              </div>
            ...
            <div className="rounded-xl bg-slate-50 p-6 flex flex-col">
              <div className="mb-4 h-40 relative overflow-hidden">
                <Image src="/assets/images/solutions/temp/mismatched-systems.jpg" alt="Mismatched Systems" fill className="object-cover rounded-lg" />
              </div>
            ...
            <div className="rounded-xl bg-slate-50 p-6 flex flex-col">
              <div className="mb-4 h-40 relative overflow-hidden">
                <Image src="/assets/images/solutions/temp/low-intelligence.jpg" alt="Low Intelligence Level" fill className="object-cover rounded-lg" />
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-16">
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-slate-100 flex flex-col lg:flex-row gap-12 items-center">
              <div className="lg:w-2/5 flex justify-center">
                <div className="relative w-full max-w-sm aspect-square">
                  <Image src="/assets/images/solutions/temp/dodoshark-roller-crusher.png" alt="Roller Crusher" fill className="object-contain" />
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-slate-100 flex flex-col lg:flex-row-reverse gap-12 items-center">
              <div className="lg:w-2/5 flex justify-center">
                <div className="relative w-full max-w-sm aspect-square">
                  <Image src="/assets/images/solutions/temp/dodoshark-hammer-mill.png" alt="Hammer Mill" fill className="object-contain" />
                </div>
              </div>
              <div className="lg:w-3/5">
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-slate-100 flex flex-col lg:flex-row gap-12 items-center">
              <div className="lg:w-2/5 flex justify-center">
                <div className="relative w-full max-w-sm aspect-square">
                  <Image src="/assets/images/solutions/temp/dodoshark-claw-mill.png" alt="Claw Mill" fill className="object-contain" />
                </div>
              </div>
              <div className="lg:w-3/5">
            ...
            <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-slate-100 flex flex-col lg:flex-row-reverse gap-12 items-center">
              <div className="lg:w-2/5 flex justify-center">
                <div className="relative w-full max-w-sm aspect-square">
                  <Image src="/assets/images/solutions/temp/dodoshark-ultrafine-mill.png" alt="Ultrafine Mill" fill className="object-contain" />
                </div>
              </div>
              <div className="lg:w-3/5">
