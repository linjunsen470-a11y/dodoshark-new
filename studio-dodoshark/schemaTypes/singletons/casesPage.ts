...
export default defineType({
  ...
  fields: [
    ...
    deprecatedField({name: 'cta', title: 'Bottom CTA (Deprecated)', type: 'object', fields: [defineField({name: 'title', title: 'Title', type: 'string'}), defineField({name: 'buttonText', title: 'Button Text', type: 'string'}), defineField({name: 'buttonLink', title: 'Button Link', type: 'url'})]}),
  ],
