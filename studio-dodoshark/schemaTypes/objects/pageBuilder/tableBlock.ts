...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'table',
      description:
        'Cells support \\n for line breaks, \\\\ for backslash, merge syntax like \\th[c=2,r=2]Text or \\td[c=2]Text, and \\skip for covered cells.',
      validation: (Rule) => Rule.required().error('Table data is required.'),
    }),
    defineField({
      name: 'hasHeaderRow',
      ...
      initialValue: true,
      description:
        'Used for normal tables. When merge syntax like \\th / \\td / \\skip is present, cell-level directives take precedence.',
    }),
